...
Centered identity composition. Colored square icon block with brand name + tagline entrance. Accent color drives the icon background. Clean, minimal, logo-sting feel.

## Use cases

Brand reveals, logo stings, identity intros, event openers, sponsorship bumpers.
