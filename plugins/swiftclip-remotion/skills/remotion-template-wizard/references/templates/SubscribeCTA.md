...
| --- | --- | --- |
| Channel avatar size | `160×160` rounded square | edit style |
| Bell icon | `Bell` (lucide-react) | swap icon |
| Subscribe button label | implied "Subscribe" | edit button text |
| Like / Mouse icon | `Heart`, `MousePointer2` (lucide-react) | swap icons |
| Accent color | `#0066cc` | edit button background |

## Visual style

Centered layout. Avatar placeholder → channel name → subscribe button with bell icon → like prompt. Staggered entrance with scale/fade. Designed for YouTube creator closers.

## Use cases

YouTube subscribe CTAs, creator channel promos, social media follow requests.
