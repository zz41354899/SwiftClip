...
| --- | --- | --- |
| Badge text | `"New"` (implied from badge component) | edit badge label |
| Headline | `"SwiftClip"` (brand headline) | edit text node |
| Subheadline | `"Beautiful motion, built for speed"` | edit text node |
| Feature list | `["10× faster than manual editing", "Beautiful, production-ready templates", "Ship polished video in minutes"]` | edit `FEATURES` array |
| Feature icons | Zap / Palette / Rocket (lucide-react) | swap icon components |
| Icon colors | `#6366f1`, `#a855f7`, `#ec4899` | edit color props |
| CTA arrow | ArrowRight icon | edit bottom CTA section |

## Visual style

Full-bleed vertical layout with background glow blobs. Top badge → headline + subheadline → staggered feature list cards → CTA with pulse animation. Purple-to-pink gradient accent palette.

## Use cases

Instagram Reels, TikTok promos, YouTube Shorts, vertical social ads.
