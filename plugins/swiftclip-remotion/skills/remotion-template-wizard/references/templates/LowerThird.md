...
Frosted glass pill in lower-left quadrant. Headline (name) + subheadline (title/role). Slide-in from left, clean exit. Designed to overlay on top of existing video footage.

## Use cases

Speaker nameplates, event lower-thirds, broadcast IDs, podcast overlays, interview captions.
