...
const steps = [
  {
    ...
    description: "Browse the library, copy the .tsx file, and drop it into your remotion/ folder.",
  },
  {
    number: "02",
    Icon: Settings2,
    title: "Customise with props",
    description: "Every template is fully typed. Edit colours, text, and timing directly in your IDE.",
  },
  {
    number: "03",
    Icon: Rocket,
    title: "Render & ship",
    description: "Run one CLI command to export an MP4, GIF, or WebM — ready for any platform.",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-[40px] sm:text-[48px] font-semibold text-black tracking-[-0.03em] leading-[1.1] mb-6">
            From template <br />
            <span className="text-black/40">to rendered video.</span>
          </h2>
