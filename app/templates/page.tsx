    ...
    <div className="min-h-screen bg-zinc-50 flex flex-col selection:bg-indigo-100">
      ...
      <div className="pt-40 pb-16 px-6 relative overflow-hidden bg-white border-b border-zinc-200">
        ...
        <div className="max-w-6xl mx-auto relative z-10 text-center">
          ...
          >
            A curated collection of {templates.length} production-ready Remotion compositions. 
            Fully customizable, open-source, and engineered for scale.
          </motion.p>
      ...
      {/* Mobile sidebar-style filter — visible below lg */}
          ...
          <AnimatePresence mode="popLayout">
            {filtered.length === 0 ? (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-zinc-900 mb-2">No templates found</h3>
                <p className="text-zinc-500">We couldn't find anything matching "{searchQuery}"</p>
              </motion.div>
            ) : (
              <motion.div 
                layout
